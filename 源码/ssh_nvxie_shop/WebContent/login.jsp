...
<head>
 ...
 function check2()
 {
	 ...
	 {
		 alert("请输入验证码");
		 document.ThisForm.rand.focus();
		 return false;
	 }
	 //document.getElementById("indicator").style.display="block";
	 loginService.login2(document.ThisForm.loginname.value,document.ThisForm.loginpw.value,0,document.ThisForm.rand.value,callback);
 }
 </script>
</head>
<body>
...
<body>
	...
	<br>
	<br>
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/images/login_bg.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 40pt;">管理登录</div></td>
	 </tr>
	 <tr>
		<td width="559">
				...
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
			        ...
			        <tr>
						...
						<td width="356" valign="bottom">
					        <input name="loginname"  type="text" class="input2" onMouseOver="this.style.background='#F0DAF3';" onMouseOut="this.style.background='#FFFFFF'">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td height="31" colspan="2" valign="top" class="STYLE15">
						     密&nbsp;&nbsp;&nbsp;&nbsp;码：
							<input name="loginpw" type="password" size="21" class="input2" align="bottom" onMouseOver="this.style.background='#F0DAF3';" onMouseOut="this.style.background='#FFFFFF'">
						</td>
					</tr>
					<tr>
						<td height="31" colspan="2" valign="top" class="STYLE15">
							验证码：<input name="rand" type="text" style="width: 200px;height: 20px;"/> <img border=0 src="<%=path %>/image.jsp" class="yzm-img"/>
							<%--<input name="loginpw" type="password" size="21" class="input2" align="bottom" onMouseOver="this.style.background='#F0DAF3';" onMouseOut="this.style.background='#FFFFFF'">--%>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" valign="top">&nbsp; &nbsp; &nbsp; &nbsp;
							<input name="button" type="button" class="submit1" value="登录" onClick="check2()"> &nbsp;
