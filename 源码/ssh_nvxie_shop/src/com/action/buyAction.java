...
public class buyAction extends ActionSupport
{
	...
	public String addToCart()
	{
		...
		orderItem.setFuid(goods.getUid());
	...
	public String orderSubmit()
	{
		...
		for (Iterator it = cart.getItems().values().iterator(); it.hasNext();)
		{
			...
			orderItem.setFuid(orderItem.getGoods().getUid());
		...
		user.setJifen(String.valueOf(Integer.parseInt(user.getJifen() ) +  cart.getTotalPrice()/10  ));
		user.setMoney(String.valueOf(Integer.parseInt(user.getMoney() ) -  cart.getTotalPrice()  ));
